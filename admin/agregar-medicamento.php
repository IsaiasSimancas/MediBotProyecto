...
try {
    ...
    $categorias = ['Analgésicos', 'Antiinflamatorios', 'Antibióticos', 'Gastrointestinal', 'Vitaminas', 'Antialérgicos'];
}
?>
...
<head>
    ...
    <title>Medibot - Agregar Medicamento</title>
...
<body>
    ...
    <div class="main-content">
        <!-- Top Bar -->
        <div class="top-bar">
            <div class="page-title">Agregar Medicamento</div>
        ...
        <div class="form-container">
            <div class="form-header">
                <div class="form-title">Agregar Nuevo Medicamento</div>
            ...
            if (isset($_GET['success']) && $_GET['success'] == 1) {
                echo '<div class="alert alert-success">
                    <i class="fas fa-check-circle mr-2"></i> Medicamento agregado correctamente.
                </div>';
            }
            ...
            <div class="form-card">
                <form action="../api/agregar-medicamento.php" method="POST" enctype="multipart/form-data">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="principio_activo" name="principio_activo" class="form-input">
                        </div>
                        
                        <div class="form-group">
                            <label for="presentacion" class="form-label">Presentación</label>
                            <input type="text" id="presentacion" name="presentacion" class="form-input">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="dosificacion" name="dosificacion" class="form-textarea"></textarea>
                    </div>
